      ...
      <div className="container mx-auto px-4 py-16 sm:py-24">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl dark:text-white">
            <span className="block">RAG News Generator</span>
...
const features = [
  {
    ...
    description:
      "Leverage advanced AI models to generate high-quality, contextually relevant content.",
  ...
  },
  {
    ...
    description:
      "Tailor your content with customizable tones and styles to match your brand voice.",
    icon: ({ className }: { className: string }) => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Generate content optimized for various platforms, from social media to blog posts.",
    icon: ({ className }: { className: string }) => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
